...
@Getter
@Setter
@Schema(description = "거래 내역 수정 요청")
public class UpdateTransactionRequest {
    ...
    @Schema(description = "거래 금액", example = "600000", minimum = "0.01")
    ...
    @Schema(description = "거래 설명", example = "웨딩홀 예약금 수정", maxLength = 100)
    private String description;
    
    @Size(max = 500, message = "메모는 최대 500자까지 입력 가능합니다.")
    @Schema(description = "거래 메모", example = "신라호텔 예약금 (수정됨)", maxLength = 500, required = false)
    private String memo;
